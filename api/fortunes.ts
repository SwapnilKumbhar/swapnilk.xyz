...
const fortunes = [
  ...
  "Was looking for an internship for the Summer of 2022.",
  "[object Object]",
  ...
  "Free, as in Freedom.",
  "Just a friendly reminder - Please lint your code.",
  "Currently solving performance issues that do not exist",
  "Of course I love Leetcode!",
];
...
const getNewFortune = (ts: number): string =>
  ts.toString().includes("444")
    ? "It is Pooja time."
    : fortunes[ts % fortunes.length];
