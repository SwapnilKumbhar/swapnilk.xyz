...
date: Mon Jan  2 07:22:06 AM UTC 2023
---
...
"Most people", however, often leaves out the elderly. According to a 2019 Mint [article](https://www.livemint.com/education/news/why-is-digital-literacy-important-for-elderly-1568620357404.html), 86% of elderly were "digitally illiterate" (harsh term, IMHO). The study, conducted by the [Agewell Foundation](https://www.agewellfoundation.org/?page_id=1162), defined "elderly" as people over the age of 55. Despite the study being four years old, the study's findings still hold true today.
...
I divided tech skills into three categories, each with increasing levels of complexity. Individually, each of them are relatively small and easy to conquer. Overall, it is a journey that starts from the foundations and ends at independence. If the person being taught to can teach themselves, you're done.
...
Smartphones and Tablets are easier to use as there's only one peripheral: The screen. If your elders can unlock the phone, open applications, install new applications and type texts. These are the basics. Further, if they can read and understand what the application wants them to do, that's just an added bonus.


### Desktop and Laptop Computers

Things get tricky here as there are three peripherals to worry about: The keyboard, mouse/trackpad and the screen. Further, using peripherals like mouse is harder due to its unfamiliarity. I think the test described above would pretty much work here too. 
...
Now that we're confident that our student is familiar with actually interacting with the devices, let's jump to the important stuff. Here's where we aim to teach our elders, certain applications that make their lives simpler.

Most of these technologies are aimed towards enabling our elders to achieve freedom: Freedom to pay for themselves, commute, etc.

## Making payments over UPI

If you are living in a fairly urban or tourist-heavy place, you'll see those little UPI QR codes at nearly every shop. Auto Rickshaws in Mumbai have it, so do street vendors and nearly everyone. UPI is also used to pay some fairly important bills too, like electricity and mobile phone bills. Teaching UPI to our elders gives them the freedom to transfer relatively small amounts of money without using cash. 
...
By no means is this an exhaustive list. There are many other things that can be taught by you. But your goal isn't to teach them a set of applications or a device. The goal is to teach them to help themselves with technology. If your parent, or whoever it is that you are teaching, is able to solve their problem by Googling its solution, then your job is done.

I am sure my mother would soon be able to do that, and she will not need to ask my brother of I for any help with technology. The feeling of learning something new, of being self-sufficient is priceless. I am sure this will be a pretty fulfilling experience for you too. 
